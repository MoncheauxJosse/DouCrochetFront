  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object().shape({
      ...
      quantity: Yup.number()
        .integer()
        .min(1, "minimum 1")
        .required("texte non autorisé dans quantité"),
    }),
    ...
    if (duplicateId == true) {
      ...
      return [
        ...formik.values.categoryId,
        {
          ...
          name: data.data[e.target.value].name,
        },
      ];
    }
  };
  ...
  return (
    <div className="bg-light-yellow flex h-full flex-col items-center justify-center">
      <form
        ...
        className="bg-light-pink shadow-xl rounded px-8 pt-6 pb-8 mb-4"
      >
        <div className="mb-2 flex justify-center">
          <label className="font-bold text-light-yellow text-xl">
            Créer un produit
          </label>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className=" flex justify-center">
            {formik.errors.name && (
              <p className="error text-xs text-red-600">{formik.errors.name}</p>
            )}
          </div>
        </div>
        ...
        <div className="mb-2 flex justify-center">
          <label htmlFor="price" className="font-bold text-light-yellow">
            créer une Catégorie
          </label>
        </div>
        <div className="mb-4">
          <div className="mb-2 flex justify-center">
            ...
            />
            <div
              name="Button-Create-Category"
              className="btn bg-light-yellow"
              ...
              return (
                <div className="mb-2 flex justify-center">
                  <div key={index} id={index}>
                    {formik.values.categoryId[index].name}
                    <div
                      className="btn px-2.5 py-0.5 rounded-full text-white bg-light-pink hover:bg-dark-pink"
                      onClick={() => {
                        formik.setFieldValue("categoryId", deleteChoice(index));
                      }}
                    >
                      X
                    </div>
        ...
        <div className="mb-8 flex gap-20">
          <label
            ...
            className={
              formik.errors.image
                ? "input-error btn bg-light-yellow"
                : "btn h-10 bg-light-yellow"
            }
          >
            Choisir image
          </label>
        ...
        <div className=" flex justify-center">
          {formik.errors.image && (
            <p className="error text-xs text-red-600">{formik.errors.image}</p>
          )}
        </div>
        ...
        <div className="mb-2 flex justify-center">
          ...
          <label htmlFor="quantity" className="font-bold text-light-yellow">
            Quantitées :
          </label>
